...
# 既知座標マスタ（拠点・顧客・戦略拠点すべて含む）
KNOWN_COORDS = {
    # ── 自社・主要拠点 ──────────────────────────
    "GS境": (36.2215, 139.8340),
    "GS境拠点": (36.2215, 139.8340),
    "GS境（自社冷蔵）": (36.2215, 139.8340),
    "境町": (36.2215, 139.8340),
    "美里工場": (36.3042, 137.1371),

    # ── 戦略拠点（物流プラットフォーム） ────────
    "KIFA川越": (35.9252, 139.4853),
    "KIFA川越（OEM連携）": (35.9252, 139.4853),
    "川越センター": (35.9252, 139.4853),
    "中越通運（羽生）": (36.1724, 139.5867),
    "中越通運 羽生": (36.1724, 139.5867),
    "羽生センター": (36.1724, 139.5867),
    ...
    # ── 将来候補サテライト ───────────────────────
    "大田市場": (35.5639, 139.7175),
    "豊洲市場": (35.6455, 139.7829),
}
